...
HOMEPAGE="https://github.com/asmodehn/pyros"
SRC_URI="https://github.com/asmodehn/${PN}-rosrelease/archive/release/kinetic/${PN}/0.4.1-1.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
